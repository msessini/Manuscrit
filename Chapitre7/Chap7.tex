...
La suite de la procédure consiste à vérifier les impacts observés, après ajustement données. Le BDT utilisé ayant été entraîné sur des échantillons de 2018 uniquement, ces données seront d'abord dévoilées dans un premier temps afin de s'assurer qu'aucun biais n'ait été introduit lors de la classification des évènements. 
