...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.5\linewidth}
        ...
        \caption{$Z\rightarrow\tau\tau$ Embed} 
        \vspace{0.5ex}
    \end{subfigure}
        \begin{subfigure}[b]{\linewidth}
        \centering
        ...
        \vspace{0.5ex}
    \end{subfigure}
    \caption{Distribution du score de sortie du BDT dans la catégorie Jet Fakes (a), $Z\rightarrow\tau\tau$ Embed (b) et Higgs (c).}
    \label{BDTscores}
\end{figure}
...
\begin{figure}
        \centering
        \includegraphics[scale=0.28]{Chapitre7/Images/CtrlPlots/2018/phiCP_nominal_HiggsUnrolled.png} 
        \caption{Higgs} 
        \label{unrolled}
\end{figure}
...
\begin{figure}
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[scale=0.25]{Chapitre7/Images/CtrlPlots/2018/BDTscoreA1MUJetFakes.png} 
        \caption{Jet Fakes} 
        \vspace{0.5ex}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[scale=0.25]{Chapitre7/Images/CtrlPlots/2018/BDTscoreA1MUZTT.png} 
        \caption{$Z\rightarrow\tau\tau$ Embed} 
        \vspace{0.5ex}
    \end{subfigure}
    \caption{}
...
\begin{figure}[!ht]
        \centering
        \includegraphics[scale=0.7]{Chapitre7/Images/impacts_run2blind-1.pdf} 
        \vspace{0.5ex}
    \caption{}
...
\begin{figure}
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[scale=0.28]{Chapitre7/Images/htt_mt_1_2018-saturated.pdf} 
        \caption{} 
        \vspace{0.5ex}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[scale=0.28]{Chapitre7/Images/htt_mt_2_2018-saturated.pdf} 
        \caption{} 
        \vspace{0.5ex}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[scale=0.28]{Chapitre7/Images/htt_mt_3_2018-saturated.pdf} 
        \caption{} 
        \vspace{0.5ex}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\linewidth}
        \centering
        \includegraphics[scale=0.28]{Chapitre7/Images/htt_mt_4_2018-saturated.pdf} 
        \caption{} 
        \vspace{0.5ex}
    \end{subfigure}
    \caption{Qualité d'ajustement saturé dans la catégorie $Z\rigtharrow\tau\tau$ (a), dans la catégorie \textit{jetFakes} (b) et dans la catégorie de signal pour le vecteur polarimétrique (c) et la méthode du pion neutre (d).}
    \label{BDTscores}
\end{figure}
